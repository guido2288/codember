const searchPatterns = (text) => {
    ...
    const newArr = Object.entries(result);
    let resultado = [];

    newArr.forEach(element => {
        resultado.push( element.join(""))
    });
